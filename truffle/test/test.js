...
//         return usingProperty.deployed().then(function (property) {
//             instance = property;
//             return instance.addProperty("gg", 4, 1, ":D", 1, 1, { from: accounts[3] });
//
//         }).then(function(txs){
//
//         });
...
//         return usingProperty.deployed().then(function (property) {
//             instance = property;
//             return instance.addProperty("tt", 4, 1, ":D", 2, 1, { from: accounts[3] });
//
//         }).then(function(txs){
//
//         });
...
//         return usingProperty.deployed().then(function (property) {
//             instance = property;
//             return instance.updatePropertyTypeRating(0, 5000, "update", { from: accounts[3] });
//
//         }).then(function(txs){
//
//         });
